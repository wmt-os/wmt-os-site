...
Images are dated builds named `wmt-os-<profile>-<stamp>.img.xz`, published at [releases.wmt-os.org](https://releases.wmt-os.org/) with a SHA-256 checksum alongside.
